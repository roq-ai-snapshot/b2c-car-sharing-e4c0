...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'company.create': { roles: ['owner'], key: 'new-company-registration', tenantPath: [], userPath: [] },
  'car.create': { roles: ['fleet-manager'], key: 'new-car-added', tenantPath: ['company', 'car'], userPath: [] },
  'car.update': { roles: ['guest'], key: 'car-status-updated', tenantPath: ['company', 'car'], userPath: [] },
  'booking.delete': {
    roles: ['guest'],
  ...
  'user.update': { roles: ['guest'], key: 'personal-details-updated', tenantPath: ['company', 'user'], userPath: [] },
};
